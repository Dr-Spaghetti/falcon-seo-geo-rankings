/** Known LF firm hubs shown in AppShell nav (client-safe; no Node fs). */
export const LF_CLIENT_NAV = [
  { slug: "therman", label: "Therman", href: "/clients/therman" },
  { slug: "premier", label: "Premier", href: "/clients/premier" },
  {
    slug: "michael-marr",
    label: "Michael Marr",
  ...
  {
    slug: "gold-dog",
    label: "Gold Dog Injury Law",
    href: "/clients/gold-dog",
  },
  {
    slug: "kunka",
    label: "Kunka Law",
  ...
  },
  {
    slug: "mary-higgins",
    label: "Mary Higgins",
    href: "/clients/mary-higgins",
  },
  {
    slug: "shammas-law",
    label: "Shammas Law",
    href: "/clients/shammas-law",
  },
  {
    slug: "farias-firm",
    label: "Farias Firm",
    href: "/clients/farias-firm",
  },
] as const;
