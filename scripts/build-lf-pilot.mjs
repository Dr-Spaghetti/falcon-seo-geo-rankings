#!/usr/bin/env node
/**
 * Backward-compatible Therman builder.
 * Safe: only touches Therman place IDs + clients/therman.json + pilot-client.json.
 * Does NOT wipe other clients' location JSON under data/lf/locations/.
 *
 * Prefer: npm run build:lf -- --client=therman
 */
