...
export function generateStaticParams() {
  return listClientPlaceIds("widrig").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Widrig Law · Falcon",
    description: "Local Falcon scans for " + city + " (Widrig Law)",
  };
}

export default function WidrigLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
