...
export function generateStaticParams() {
  return listClientPlaceIds("jones-swanson").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Jones & Swanson · Falcon",
    description: "Local Falcon scans for " + city + " (Jones & Swanson)",
  };
}

export default function JonesSwansonLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
