...
export function generateStaticParams() {
  return listClientPlaceIds("farias-firm").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Farias Firm · Falcon",
    description:
      "Local Falcon scans for " + city + " (Farias Firm)",
  };
}

export default function FariasFirmLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
