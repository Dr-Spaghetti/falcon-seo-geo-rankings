...
export function generateStaticParams() {
  return listClientPlaceIds("omega").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Omega Law Group · Falcon",
    description: "Local Falcon scans for " + city + " (Omega Law Group)",
  };
}

export default function OmegaLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
