...
export function generateStaticParams() {
  return listClientPlaceIds("pearl-thompson").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Pearl & Thompson · Falcon",
    description:
      "Local Falcon scans for " + city + " (Pearl & Thompson)",
  };
}

export default function PearlThompsonLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
