...
export function generateStaticParams() {
  return listClientPlaceIds("kunka").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Kunka Law · Falcon",
    description: "Local Falcon scans for " + city + " (Kunka Law)",
  };
}

export default function KunkaLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
