...
export function generateStaticParams() {
  return listClientPlaceIds("shammas-law").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Shammas Law · Falcon",
    description:
      "Local Falcon scans for " + city + " (Shammas Law)",
  };
}

export default function ShammasLawLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
