...
export function generateStaticParams() {
  return listClientPlaceIds("mary-higgins").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Mary Higgins · Falcon",
    description:
      "Local Falcon scans for " + city + " (Mary Higgins)",
  };
}

export default function MaryHigginsLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
