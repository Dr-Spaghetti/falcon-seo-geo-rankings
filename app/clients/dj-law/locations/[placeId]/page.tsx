...
export function generateStaticParams() {
  return listClientPlaceIds("dj-law").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · DJ Law Corp · Falcon",
    description:
      "Local Falcon scans for " + city + " (DJ Law Corp)",
  };
}

export default function DjLawLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
