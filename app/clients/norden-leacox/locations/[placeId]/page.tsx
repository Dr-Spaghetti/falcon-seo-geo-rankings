...
export function generateStaticParams() {
  return listClientPlaceIds("norden-leacox").map((placeId) => ({ placeId }));
}
...
export function generateMetadata({
  ...
  return {
    title: city + " · Norden Leacox · Falcon",
    description: "Local Falcon scans for " + city + " (Norden Leacox)",
  };
}

export default function NordenLeacoxLocationPage({
  params,
}: {
  params: { placeId: string };
}) {
